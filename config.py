...
MAX_LEN = 50  # 6081 datapoints are more than 60 length out of 2238471 which is just 0.2% of dataset
...
df_path = r"/content/drive/My Drive/AGJCSV/processed_new.csv"  # (2244552, 2)
